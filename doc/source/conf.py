# -*- coding: utf-8 -*-
#
# GPTwoSample documentation build configuration file, created by
...
project = u'PyGP'
copyright = u'2010, Oliver Stegle, Max Zwießele, Nicolò Fusi'
...
latex_documents = [
  ('index', 'PyGPdoc.tex', u'PyGP Documentation',
   u'Oliver Stegle, Max Zwießele, Nicolò Fusi', 'manual'),
]
...
man_pages = [
    ('index', 'pygp', u'PyGP Documentation',
     [u'Oliver Stegle, Max Zwießele, Nicolò Fusi'], 1)
]
